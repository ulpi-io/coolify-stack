...
stacks=(
  ...
  'kensi-ai|Kensi AI|/platforms/kensi-ai/compose.yaml|Kensi AI Stack|[{"name":"web","domain":"https://kensi.ai"},{"name":"nginx","domain":"https://api.kensi.ai"}]|Production Kensi AI web and API stack.'
  ...
  'insight|Clavinci|/platforms/insight/compose.yaml|Clavinci Stack|[{"name":"dashboard","domain":"https://clavinci.com"}]|Production Clavinci stack.'
  'togglebox|Togglebox|/platforms/togglebox/compose.yaml|Togglebox Stack|[{"name":"admin","domain":"https://togglebox.dev"},{"name":"api","domain":"https://api.togglebox.dev"}]|Production Togglebox admin and API stack.'
  ...
  'ploon|Ploon|/platforms/ploon/compose.yaml|Ploon Stack|[{"name":"web","domain":"https://ploon.ai"}]|Production Ploon web stack.'
  'open-growth-group|Open Growth Group|/platforms/open-growth-group/compose.yaml|Open Growth Group Stack|[{"name":"web","domain":"https://opengrowthgroup.co"}]|Production Open Growth Group website stack.'
  'lokei|Lokei|/platforms/lokei/compose.yaml|Lokei Stack|[{"name":"web","domain":"https://lokei.dev"},{"name":"nginx","domain":"https://api.lokei.dev"},{"name":"relay","domain":"https://relay.lokei.dev"}]|Production Lokei web, API, workers, and relay stack.'
  'albert|Albert|/platforms/albert/compose.yaml|Albert Stack|[{"name":"web","domain":"https://albert.con.fyi"}]|Production Albert application stack.'
  'record-cloud|Record Cloud|/platforms/record-cloud/compose.yaml|Record Cloud Stack|[{"name":"web","domain":"https://record.con.fyi"},{"name":"api","domain":"https://api.record.con.fyi"}]|Production Record Cloud web and API stack.'
...
while IFS=$'\t' read -r slug _ application_uuid domains_json; do
  ...
  [[ $parsed -eq 1 ]] || die "Coolify did not parse $slug Compose file"
